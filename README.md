...
2. **Clone this repository.** - `git clone https://github.com/tranthanh95/react-redux-starter.git` or [download the zip](https://github.com/tranthanh95/react-redux-starter/tree/master)
...
8. Use path.resolve on all path references in both the dev and prod webpack.config.
